...
func TestTimeStampStateProof(t *testing.T) {
	...
	encodedStorageKey, err := hex.DecodeString("f0c365c3cf59d671eb72da0e7a4113c49f1f0515f462cdcf84e0f1d6045dfcbb")
	require.NoError(t, err)

	// expected value : 1,683,620,592,000
	var expectedVaule uint64 = 1683620592000

	proof1, err := hex.DecodeString("")
	require.NoError(t, err)
	...
	proofs, err := hex.DecodeString("")
	require.NoError(t, err)
	n2, err := node.Decode(bytes.NewReader(proofs))
	require.NoError(t, err)
	_, _ = n2.CalculateMerkleValue()
	t.Log("N2:", n2)

	proof3, err := hex.DecodeString("9ec365c3cf59d671eb72da0e7a4113c41002505f0e7b9012096b41c4eb3aaf947f6ea429080000685f0f1f0515f462cdcf84e0f1d6045dfcbb2080799bff87010000")
	require.NoError(t, err)
	...
	proof := [][]byte{proof1, proofs, proof3}

	trie, err := buildTrie(proof, stateRoot)
	// t.Log("TRIE:", trie)
	require.NoError(t, err)

	value := trie.Get(encodedStorageKey)
	...
	require.Equal(t, timestamp, expectedVaule)
